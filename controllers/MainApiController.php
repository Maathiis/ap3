...
class MainApiController extends ApiController
{
   ...
   /* function getRessourcesRandomByVille(int $limite = 10): string
    {
        $ressources = $this->ressourceModel->getRandomRessourceByVille($limite);
    ...
    function getRessourcesNew(int $limite = 10): string
    {
        $ressources = $this->ressourceModel->getNewRessource($limite);
     ...
     /* function getRessourcesNewByVille(int $limite = 10): string
    {
        $ressources = $this->ressourceModel->getNewRessourceByVille($limite);
